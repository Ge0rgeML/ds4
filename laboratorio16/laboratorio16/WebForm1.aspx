...
<body>
    ...
    <div class="cal">
        ...
        <asp:Label ID="l1" Text=" CALCULADORA BASICA" runat="server" 
            Style="margin-left: 50px; Font-Bold=True; Font-Italic=False; foreColor=White; Font-Size=25px"></asp:Label>
        ...
        <asp:Button ID="b1" Text="1" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b1_Click" />
        ...
        <asp:Button ID="b3" Text="3" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b3_Click" />
        ...
        <asp:Button ID="b4" Text="4" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b4_Click" />

        <asp:Button ID="b5" Text="5" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b5_Click" />

        <asp:Button ID="b6" Text="6" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b6_Click" />

        <asp:Button ID="sub" Text="-" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="sub_Click" />

        <asp:Button ID="b7" Text="7" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b7_Click" />

        <asp:Button ID="b8" Text="8" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b8_Click" />

        <asp:Button ID="b9" Text="9" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b9_Click" />

        <asp:Button ID="mul" Text="*" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="mul_Click" />

        <asp:Button ID="b0" runat="server" Text="0" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="b0_Click" />
        ...
        <asp:Button ID="eql" runat="server" Text="=" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="eql_Click" />

        <asp:Button ID="div" Text="/" runat="server" Height="37px" 
            Style="margin-left: 0px;" Width="57px" OnClick="div_Click" />
    </div>
    </form>
</body>
</html>
